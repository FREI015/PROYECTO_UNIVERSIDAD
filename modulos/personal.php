...
if (empty($_SESSION["user"]) && empty($_SESSION["usuario_id"]) && empty($_SESSION["usuario"])) {
  go(BASE_URL . "/login.php?next=" . urlencode(BASE_URL . "/modulos/personal.php"));
}

requirePermiso("ver_personal", BASE_URL . "/modulos/asistencias.php");

// 24A2_PERSONAL_TURNO_SCOPE_INIT
...
// Turnos disponibles.
// 24A2_PERSONAL_TURNOS_FILTRADOS
...
<script>
/* 25A2N1_PERSONAL_VISUAL_MARKERS */
(function(){
