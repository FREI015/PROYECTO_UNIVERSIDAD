...
if (empty($_SESSION["user"]) && empty($_SESSION["usuario_id"]) && empty($_SESSION["usuario"])) {
  go(BASE_URL . "/login.php?next=" . urlencode(BASE_URL . "/modulos/usuarios.php"));
}
...
<div class="users-roles-scope" role="region" aria-label="Alcance de roles">
  <div class="users-roles-scope-header">
    <div>
      ...
      <p class="users-roles-scope-sub">Guia rapida para seleccionar el rol correcto al crear usuarios. Este bloque es informativo y no cambia permisos internos.</p>
    </div>
  </div>
  ...
  <div class="users-roles-scope-grid">
    ...
    <div class="users-role-card">
      ...
      <p>Supervision general de asistencia, personal, reportes, permisos y reposos.</p>
      <span>Alcance: todos los turnos</span>
    </div>

    <div class="users-role-card">
      <div class="users-role-name">Diurno / Matutino</div>
      <p>Usuario operativo limitado al turno de la manana o jornada matutina.</p>
...
<!-- END_25A2O2_USUARIOS_ROLES_SCOPE -->
...
<script>
/* 25A2O1_USUARIOS_VISUAL_MARKERS */
(function(){
