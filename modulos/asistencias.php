...
<?php if ($okEmpleado): ?>
  ...
  <div class="success-person-card">
    ...
    <div>
      <div class="success-title">Asistencia guardada con exito</div>
...
<script>
/* 25A2E2_ASISTENCIAS_FILTERS_SELECTOR_REAL */
(function(){
...
<script>
/* 25A2F5_ASISTENCIAS_ORDER_CEDULA */
(function(){
  ...
  if (alphaLink && form) {
    try {
      ...
      if (foundOrder && needsRedirect && !window.sessionStorage.getItem("asistencias_alpha_auto_25A2F5")) {
        window.sessionStorage.setItem("asistencias_alpha_auto_25A2F5", "1");
...
<script>
/* 25A2F7_ASISTENCIAS_TABLE_HEADERS_UNIFORMES */
(function(){
...
<script>
/* 25A2F8_ASISTENCIAS_HEADERS_LABELS */
(function(){
